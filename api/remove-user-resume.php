...
if($jwt){
    try {
        ...
        // send the email from jwt to authenticate user and remove their resume
        removeResume($decoded->data->email);
    }
    catch (Exception $e){
        // set response code
...
// if the jwt is correct extract user's email and remove their resume
function removeResume($jwt_email) {
