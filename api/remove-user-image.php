 ...
 *  removes user's image if they have.
 */
...
if($jwt){
    try {
        ...
        // send the email from jwt to authenticate user and remove their image
        removeImage($decoded->data->email);
    }
    catch (Exception $e){
        // set response code
...
// if the jwt is correct extract user's email and remove their image
function removeImage($jwt_email) {
